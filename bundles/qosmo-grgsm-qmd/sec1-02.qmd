...
## `qemu-calypso-qmd/qemu-calypso-full.qmd` {#f-qemu-calypso-qmd-qemu-calypso-full-qmd}

::: {.file-meta}
[.qmd]{.tag} 21954 lignes - 834KB
:::

`````{.markdown .numberLines filename="qemu-calypso-qmd/qemu-calypso-full.qmd"}
---
title: "Calypso QEMU"
subtitle: "Full source bundle - DSP C54x / osmocom-bb / SHUNT_LEGIT"
date: "2026-09-02T21:11:51+02:00"
...
Scope `.` - git `main@93c370d` - genere 2026-09-02T21:11:51+02:00
...
static void feed_agch(const uint8_t *l2, int len)
{
    ...
    bool cur_imm = (cur == 0x3f || cur == 0x3a || cur == 0x

... [TRONQUE a 512 ko - 834KB au total] ...
